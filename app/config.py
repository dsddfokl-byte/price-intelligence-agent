...
GROWTH_POLICY_INITIAL_VERSION = "growth_policy_v1"
GROWTH_ROLLBACK_MONITOR_DAYS = 7
GROWTH_GUARDRAIL_MAX_DETERIORATION = 0.30
GROWTH_MAX_PUBLISH_FAILURE_RATE = 0.20
GROWTH_MAX_DUPLICATE_RATE = 0.0
GROWTH_PERSISTENT_LOW_EXPERIMENTS = 4
POST_INTENT_EXPERIMENT_ENABLED = True
POST_INTENT_SPLIT = "50/50"
POST_INTENT_EPOCH = "v1"
AUTO_REPLY_MODE = "shadow"
TOPIC_RELEVANCE_MIN = 50.0
TOPIC_SEARCH_CACHE_TTL_HOURS = 12
TOPIC_SEARCH_MAX_REQUESTS_PER_DAY = 4
TOPIC_SEARCH_LIMIT = 25
